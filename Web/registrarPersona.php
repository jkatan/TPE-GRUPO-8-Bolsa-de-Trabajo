<?php include('header.php'); ?>
    ...
    <form class="styled-form" method="POST" action="registrarPersonaAction.php">
      ...
      <table>
        ...
        <td><label>Contraseña</label></td><td><input id="pass" class="password" type="password" name="pass" required/></td></tr>
        <td><label>Repita contraseña</label></td><td><input id="confirmPass" class="password" type="password" name="pass2" required/></td></tr>
