<?php include('header.php'); ?>
    ...
    <form class="styled-form" method="POST" action="registrarPersonaAction.php">
      ...
      <table>
        ...
        <td><label>Contraseña</label></td><td><input id="pass" class="password" type="password" name="pass" pattern="[0-9A-Za-Z]{4,8}" title="Solo numeros o letras, entre 4 y 8" required/></td></tr>
        <td><label>Repita contraseña</label></td><td><input id="confirmPass" class="password" type="password" name="pass2" pattern="[0-9A-Za-Z]{4,8}" title="Solo numeros o letras, entre 4 y 8" required/></td></tr>
